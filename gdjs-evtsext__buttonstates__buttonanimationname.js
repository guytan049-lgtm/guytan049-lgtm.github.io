...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.onCreatedContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.idToCallbackMap = new Map();
...
for (var i = 0, k = 0, l = gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("ButtonFSM")).IsIdle(eventsFunctionContext) ) {
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("ButtonFSM")).IsFocused(eventsFunctionContext) ) {
        isConditionTrue_0 = true;
        gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects2[k] = gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects2[i];
        ++k;
    }
...
for (var i = 0, k = 0, l = gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects1.length;i<l;++i) {
    if ( gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.doStepPreEventsContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("ButtonFSM")).IsPressed(eventsFunctionContext) ) {
        isConditionTrue_0 = true;
...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.IdleAnimationNameContext.idToCallbackMap = new Map();
...
let isConditionTrue_0 = false;
{
{eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getIdleAnimationName();}
}
...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetIdleAnimationNameContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.FocusedAnimationNameContext.idToCallbackMap = new Map();
...
let isConditionTrue_0 = false;
{
{eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getFocusedAnimationName();}
}
...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetFocusedAnimationNameContext.idToCallbackMap = new Map();
...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.PressedAnimationNameContext.idToCallbackMap = new Map();
...
let isConditionTrue_0 = false;
{
{eventsFunctionContext.returnValue = eventsFunctionContext.getObjects("Object")[0].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getPressedAnimationName();}
}
...
gdjs.evtsExt__ButtonStates__ButtonAnimationName.ButtonAnimationName.prototype.SetPressedAnimationNameContext.idToCallbackMap = new Map();
